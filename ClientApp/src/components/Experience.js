...
class Experience extends Component {
    constructor(props) {
        ...
        this.state = {
            positions: [], loading: true, modalOpen: false, modalState: {} };
    }
    ...
    saveModal() {
        ...
        let add = { userID: this.props.user, type: "Experience" }
        let data = { ...temp, ...add}
    ...
    async populateExperience() {
        ...
        const response = await fetch('api/user/' + this.props.user + '/positions/exp', {
    ...
    render() {
        let contents = this.state.loading
            ? <p><em>Loading...</em></p>
            : this.setPositions(this.state.positions);
        return (
            <div className="Experience">
                ...
                <Modal open={this.state.modalOpen} onClose={this.onCloseModal} center>
                    ...
                    />
                    <input id="workplace" type="text" className="workplace" placeholder="Employer"
                        onInput={e => this.updateModalState(e.target)}
                    />
                    ...
                    <textarea id="detail" className="detail" placeholder="Experience details"
                        onInput={e => this.updateModalState(e.target)}
                    />
